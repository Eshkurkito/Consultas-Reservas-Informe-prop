...
def render_owner_report_mode():
        ...
        if canal_col and canal_col in raw.columns:
            ...
            if not df_ci.empty:
                ...
                def _plot2(plt, ax):
                    ...
                    ax.set_title("Mix de canales (reservas con check-in en el periodo)")
    ...
    explain = (
        "Cálculo del pago al propietario para el periodo seleccionado.\n"
    ...
    texto_glosario = (
        ...
        "Perímetro del periodo: ingresos y noches se prorratean para contar solo lo que cae dentro del rango seleccionado."
    )
    ...
    pdf.multi_cell(0, 5, _safe_text(
        ...
        "- Los gráficos son orientativos y dependen de la disponibilidad de datos (canal, lead time).", unicode_ok))
